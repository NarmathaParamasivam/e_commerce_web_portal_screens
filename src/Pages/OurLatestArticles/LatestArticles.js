...
const LatestArticles = () => {
  const LatestArticles=[
    { 
      ...
      Discription:"Lorem Ipsum Dolor Sit Amet, Consectetur Adipi Elit. Aliquet Eleifend Viverra Enim Tincidunt Donec Quam. A in Arcu, Hendrerit Neque Dolor Morbi...",
},
